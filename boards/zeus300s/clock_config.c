/**
 * @file clock_config.c
 * @brief  Clock configuration for Zeus300S board
 *
 * Clock configuration for Zeus300S board.
 *
 ...
 * @date 2020-07-14
 * @history
 * 2021-07-01  davth  Watchdog Setup and various Clocks added
 * 2021-07-12  davth  connect peripherals clock to flexcomm0-1-2-4-5-6
 * 2021-09-06  davth  flexcomm4-5 for i2c usb hub
 */
...
static inline void _attach_peripherial_clocks() {
    // Attach Clock for 3 UART (0:Zynq, 1:GOWIN FPGA, 3:debugPort)
...
void BOARD_BootInitClocks(void) {
    ...
    /**< Setup FLEXCOMM3-4-5 clock, ISP boot & main comm. UART */
    CLOCK_AttachClk(kFRO12M_to_FLEXCOMM3);
    CLOCK_AttachClk(kFRO12M_to_FLEXCOMM4); // i2c usb hub
    CLOCK_AttachClk(kFRO12M_to_FLEXCOMM5); // i2c usb hub
}
