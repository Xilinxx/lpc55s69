...
enum _flash_ffr_page_num {
	...
	kFfrPageNum_Total	=
		(kFfrPageNum_CFPA + kFfrPageNum_CMPA + kFfrPageNum_NMPA),
};
 ...
 * @retval #kStatus_FLASH_CommandFailure access error.
 */
status_t FFR_GetCustomerData(flash_config_t *config, uint8_t *pData, uint32_t
			     offset, uint32_t len);
