 ...
 * @param base The I2C peripheral base address.
 */
static inline void I2C_MasterReset(__attribute__((unused)) I2C_Type *base)
{
}
 ...
 */
static inline uint32_t I2C_SlaveGetReceivedAddress(__attribute__((unused)) I2C_Type *base, volatile i2c_slave_transfer_t *transfer)
{
